...
Route::prefix('single')->group(function(){
    Route::get('index',[SingleController::class,'index']);
    Route::get('show/{id}',[SingleController::class,'show']);
    Route::post('store',[SingleController::class,'store']);
    Route::post('update/{id}',[SingleController::class,'update']);
    Route::delete('destroy/{id}', [SingleController::class, 'destroy']);
});