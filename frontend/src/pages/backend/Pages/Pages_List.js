...
function Pages_List() {
    ...
    useEffect(() => {
        (async function () {
            await postservice.getPageAll().then((res) => {
                setPost(res.data.page);
                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        <div className="col-sm-12">
                            <h1 className="d-inline">Danh sách trang đơn</h1>
                        </div>
                        <div className="col-sm-1 mt-2 text-right">
                            <Link className="action-btn" to="/admin/pages/trash" style={{ color: "red" }}>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <li className="nav-item">
                                    <a className="nav-link" href="/admin/page/create" role="button">
                                        ...
                                        {post.map(function (post, index) {
                                            return (
                                                <tr className="datarow" key={index}>
                                                    ...
                                                    <td>{post.metakey}</td>
                                                    <td>
                                                        <Link to={`/admin/pages/update/${post.id}`} className="">
                                                            <FaEdit /> Update
                                                        </Link>
                                                        <Link to={`/admin/pages/show/${post.id}`} className="">
                                                            <FaEye /> Detail
                                                        </Link>
                                                        <button
                                                            onClick={() => {
