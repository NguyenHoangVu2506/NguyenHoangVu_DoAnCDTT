                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-3  ">
                                        <div className="text-right ms-5">
                                            <Link to="/admin/topic" className="btn btn-sm btn-info me-3 ">
                                            ...
                                            <tr className="datarow" key={index} >
                                                ...
                                                <td>
                                                    ...
                                                    <div className="function_style d-flex" style={{fontSize:"14px"}}>
                                                        <Link to={`/admin/Topic/show/${tra.id}`}><i className="fa fa-eye me-1"></i>Chi tiết</Link>
                                                    </div>
                                                </td>
