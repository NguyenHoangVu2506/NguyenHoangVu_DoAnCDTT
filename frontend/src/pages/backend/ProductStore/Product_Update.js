    ...
    useEffect(() => {
        (async () => {
            await productservice.getById(id).then((res) => {
                ...
                setBrandId(res.data.products.brand_id);
                setCatID(res.data.products.category_id);
                setPrice(res.data.products.price);
                setDetail(res.data.products.detail);
                // setQty(res.data.product.qty);
                setStatus(res.data.products.status);
            })
        })()
    }, []);
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label>Giá bán (*)</label>
                                        <input value={price} onChange={(e) => setPrice(e.target.value)} type="number" min="10000" name="price" class="form-control" />
                                    </div>
                                    {/* <div class="mb-3">
