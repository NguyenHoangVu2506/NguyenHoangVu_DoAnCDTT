            ...
            <div className="footer-nav">
                ...
                <div className="container">
                    ...
                    <ul className="footer-nav-list">
                        ...
                        <li className="footer-nav-item">
                            <Link to={"/chinh-sach/chinh-sach-bao-mat"} className="footer-nav-link">Chính sách bảo mật</Link>
                        </li>

                        <li className="footer-nav-item">
                            <Link to={"/chinh-sach/chinh-sach-giao-hang"} className="footer-nav-link">Chính sách giao hàng</Link>
                        </li>

                        <li className="footer-nav-item">
                            <Link to={"/chinh-sach/huong-dan-mua-hang"} className="footer-nav-link">Hướng dẫn mua hàng</Link>
                        </li>

                        <li className="footer-nav-item">
                            <Link to={"/chinh-sach/dieu-khoan-dich-vu"} className="footer-nav-link">Điều khoản dịch vụ</Link>
                        </li>

                        <li className="footer-nav-item">
                            <Link to={"/chinh-sach/chinh-sach-doi-tra"} className="footer-nav-link">Chính sách đổi trả</Link>
                        </li>
